...
const SignUpStudent =
	"INSERT INTO students (student_name, student_email, student_password) VALUES ($1, $2, $3) RETURNING *";
...
const SignUpMentor =
	"INSERT INTO mentors (mentor_name, mentor_email, mentor_password) VALUES ($1, $2, $3) RETURNING *";
